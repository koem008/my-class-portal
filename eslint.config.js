...
export default tseslint.config(
  ...
  {
    // Generated by Supabase/Lovable. Formatting these files by hand creates
    // noisy diffs and is overwritten by the generators. Keep all semantic lint
    // rules active, but do not make generator formatting a CI gate.
    files: [
  ...
  {
    // previewAuthStorage.ts is maintained by the Lovable preview-auth generator.
    // Do not hand-edit its implementation just to satisfy a style-only rule.
