      ...
      <div className="mx-auto max-w-6xl px-4 py-6 md:px-8 md:py-10">
        ...
        <section className="rounded-[32px] bg-white p-6 shadow-sm md:p-9">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            ...
            <button
              disabled={!schoolId}
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-slate-900 px-5 py-3 font-medium text-white disabled:opacity-40"
            >
        ...
        {!loading && schoolId && (
          <div className="mt-6 grid gap-6 lg:grid-cols-[1.5fr_1fr]">
            ...
            <section className="rounded-3xl bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-500">Kontroly a navazující kroky.</p>
              {followups.length === 0 ? (
