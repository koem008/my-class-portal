...
const SpecialniPedagogikaCaseIdSouhrnRoute=SpecialniPedagogikaCaseIdSouhrnRouteImport.update({id:'/specialni-pedagogika/$caseId/souhrn',path:'/specialni-pedagogika/$caseId/souhrn',getParentRoute:()=>rootRouteImport} as any)
...
'/specialni-pedagogika/$caseId/souhrn':{id:'/specialni-pedagogika/$caseId/souhrn';path:'/specialni-pedagogika/$caseId/souhrn';fullPath:'/specialni-pedagogika/$caseId/souhrn';preLoaderRoute:typeof SpecialniPedagogikaCaseIdSouhrnRouteImport;parentRoute:typeof rootRouteImport};
...
const rootRouteChildren:RootRouteChildren={IndexRoute,AsistentkaRoute,HlasRoute,HodinaLessonIdRoute,KalendarRoute,RozvrhRoute,TridaRoute,ZacatekRoute,PametRoute,SpecialniPedagogikaRoute,SpecialniPedagogikaCaseIdRoute,SpecialniPedagogikaCaseIdSouhrnRoute,VytvarnaVychovaRoute}
